...
public class CheckInData {
	...
	public Boolean getIsFirst() {
		...
		if (completedCount > 0 && adherencePercent.equals(0) && pending.size() > 0
				&& (pending.get(0).getCheckInType() == CheckInType.COMBO || pending.get(0).getCheckInType() == CheckInType.ORAL)) return true;

		// NEW ORAL START
		if (enrollment.getFirstCheckInResponseDate() != null && enrollment.getPatientReportedTxStartDate() == null && needsStartDate(pending)) return true;
