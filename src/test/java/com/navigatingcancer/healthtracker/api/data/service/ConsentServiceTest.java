...
public class ConsentServiceTest {
    ...
    public void givenId_shouldFindSigningRequest(){
        ...
        when(docusignService.getSigningRequestStatus(anyString()))
                .thenReturn(sr.getStatus());
    ...
    public void givenGT_shouldReturnID(){
        PatientInfoClient.FeignClient fMock = mock(PatientInfoClient.FeignClient.class);
        Enrollment en = new Enrollment();
        en.setClinicId(1l);
        en.setPatientId(3l);
        ...
        when(fMock.getPatients(anyLong(), anyLong()))

                .thenReturn(Arrays.asList(pi));
